(function(){
    ...
    angular
       .module('ubwinoApp')
       .controller('allOngoingCtrl', allOngoingCtrl);

       allOngoingCtrl.$inject = ['$location','adminAuthentication','calendly'];

       function allOngoingCtrl($location, adminAuthentication, calendly){
